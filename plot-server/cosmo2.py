...
#  
   ...
   p1.circle('cv1','cv2',source=datasrc,size=5,fill_color='blue', fill_alpha=0.8, line_color=None,name="mycircle")
   ...
   p2.circle(x='cv1',y='cv2',source=datasrc,size=5,fill_color=colors, fill_alpha=0.8, line_color=None,name='mycircle')
